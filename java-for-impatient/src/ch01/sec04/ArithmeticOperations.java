...
public class ArithmeticOperations {
    public static void main(String[] args) {
        ...
        System.out.println(17 % 5);
        System.out.println(Math.floorMod(17, 5)); // lo mismo que 17 % 5
        ...
        int[] a = { 17, 29 };
        int n = 0;
        System.out.printf("%d %d\n", a[n++], n); // n++ form yields the value before the increment
        n = 0;
        System.out.printf("%d %d\n", a[++n], n); // ++n form yields the value after the increment
